    ...
    <div className="min-h-screen flex flex-col">
      <nav className="flex flex-col md:flex-row items-center justify-between px-6 py-4 border-b border-slate-200 bg-white shadow-sm gap-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 md:gap-6 text-sm font-medium w-full md:w-auto">
            <Link href="/" className="flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-lg border border-blue-100">
                <Home className="w-4 h-4" /> Dashboard
            </Link>
            <Link href="#" className="flex items-center gap-2 hover:text-slate-900 transition-colors text-slate-500">
                <Calendar className="w-4 h-4" /> Kehadiran
            </Link>
            <Link href="/karyawan" className="flex items-center gap-2 hover:text-slate-900 transition-colors text-slate-500">
                <Users className="w-4 h-4" /> Karyawan
            </Link>
            <Link href="/rekap" className="flex items-center gap-2 hover:text-slate-900 transition-colors text-slate-500">
                <FileText className="w-4 h-4" /> Rekap
            </Link>
            <Link href="/master" className="flex items-center gap-2 hover:text-slate-900 transition-colors text-slate-500">
